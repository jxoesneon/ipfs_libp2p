...
void main() {
  group('RelayFinder', () {
    ...
    setUp(() {
      ...
      when(mockHost.id).thenReturn(
          PeerId.fromString('12D3KooWRsfM7BCwzLRs66pj4GTp3gNoSCiQ5rSB3CiYXysKCyoZ'));
    });
    ...
    group('Circuit Address Construction', () {
      test('should construct valid circuit addresses from reservations', () async {
        ...
        // Current format: relayAddr/p2p/<relay>/p2p-circuit/p2p/<host>
        expect(firstCircuitAddr, contains('/p2p-circuit/p2p/'),
          reason: 'Address should carry /p2p-circuit followed by the host peer ID');
      });
